                            ...
                            isChanged ?
                                <>
                                    <Col lg={{ span: 5, offset: 6 }}>
                                        ...
                                        <h5 className='text-white' onClick={handleClick}>Vision <img style={{ width: "50%" }} src={visionArrow} alt="" /> <span style={{ fontWeight: "200", }}> Mission </span> </h5>
                                    </Col>
                                ...
                                <>
                                    <Col lg={{ span: 5, offset: 6 }}>
                                        ...
                                        <h5 className='text-white' onClick={handleClick}><span style={{ fontWeight: "200", }}> Vision </span> <img style={{ width: "50%" }} src={missionArrow} alt="" /> Mission </h5>
                                    </Col>
